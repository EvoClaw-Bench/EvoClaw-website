...
<header class="hero">
  ...
  <div class="news-stack">
    ...
    <div class="news-banner" style="--accent:#10A37F">
      <span class="news-tag">NEW</span>
      <span class="news-text"><strong>GPT-5.5</strong> (Codex) takes the #2 official spot at <strong>37.77%</strong>.</span>
    </div>
    <div class="news-banner news-banner--moonshot">
      <span class="news-tag">NEW</span>
      <span class="news-text"><strong>Kimi K2.6</strong> achieves the best open-source model at <strong>34.69%</strong>.</span>
    </div>
    <div class="news-banner news-banner--zai">
      <span class="news-tag">NEW</span>
      <span class="news-text"><strong>GLM-5.1</strong> ranks #2 open-source at <strong>28.77%</strong>.</span>
    </div>
  </div>
...
function renderChart() {
  ...
  const annotations = fdata.map(d => {
    const pos = d.chart_textpos || 'middle right';
