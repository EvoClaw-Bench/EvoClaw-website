...
<header class="hero">
  ...
  <div class="news-stack">
    ...
    <div class="news-banner news-banner--moonshot">
      <span class="news-tag">NEW</span>
      <span class="news-text"><strong>Kimi K2.6</strong> is the best open-source model at <strong>34.69%</strong>, but uses the most turns.</span>
    </div>
    <div class="news-banner news-banner--zai">
      <span class="news-tag">NEW</span>
      <span class="news-text"><strong>GLM-5.1</strong> ranks #2 open-source at <strong>28.77%</strong> with about half the turns.</span>
    </div>
  </div>
