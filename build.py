...
<link rel="icon" type="image/png" href="/leaderboard/evoclaw_icon.png">
...
<header class="hero">
  <h1 class="hero-title">
    <img class="title-icon" src="/leaderboard/evoclaw_icon.png" alt=""><span class="brand">EvoClaw</span><span class="sep">:</span><span class="desc">Evaluating AI Agents on Continuous Software Evolution</span>
  </h1>
